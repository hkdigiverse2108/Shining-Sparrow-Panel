...
export const Queries = {
  ...
  useGetDashboardAnalytics: (params?: Params) => useQueries<any>([KEYS.DASHBOARD.ANALYTICS, params], () => Get(URL_KEYS.DASHBOARD.ANALYTICS, params)),
  useGetLoginHistory: (params?: Params) => useQueries<any>([KEYS.DASHBOARD.LOGIN_HISTORY, params], () => Get(URL_KEYS.DASHBOARD.LOGIN_HISTORY, params)),
